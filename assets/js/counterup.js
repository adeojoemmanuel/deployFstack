            ...
            var e = t(this),
                ...
                a = function () {
                    ...
                    for (var o = (/^[0-9]+$/.test(a), /^[0-9]+\.[0-9]+$/.test(a)), c = o ? (a.split(".")[1] || []).length : 0, s = n; s >= 1; s--) {
                        ...
                        if ((o && (d = parseFloat((a / n) * s).toFixed(c)), r)) for (; /(\d+)(\d{3})/.test(d.toString()); ) d = d.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                        t.unshift(d);
                    }
                    ...
                    var i = function () {
                        e.data("counterup-nums") &&
                            ...
                            e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), u.delay) : (delete e.data("counterup-nums"), e.data("counterup-nums", null), e.data("counterup-func", null)));
                    };
